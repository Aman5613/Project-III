    ...
    return (
        <div className="flex flex-col items-center justify-center w-full h-screen">
            ...
            <form onSubmit={handleSubmit(registerHandler)} className="flex flex-col space-y-10">
                <input {...register("name")} type="text" placeholder="Enter Your Name" className="w-50 md:w-100 border-b outline-none text-center border-gray-500 text-black" />
                <input {...register("email")} type="email" placeholder="Enter Your Email" className="w-50 md:w-100 border-b outline-none text-center border-gray-500 text-black" />
